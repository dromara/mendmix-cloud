...
import org.dromara.mendmix.cache.redis.JedisProviderFactory;
import org.dromara.mendmix.cache.redis.sentinel.JedisSentinelProvider;
import org.dromara.mendmix.cache.redis.standalone.JedisStandaloneProvider;
...
public class RedisLockCoordinator {
	...
	public RedisLockCoordinator() {	
		...
		String mode = ResourceUtils.getProperty("mendmix-cloud.lock.redis.mode", ResourceUtils.getProperty("mendmix-cloud.cache.mode","standalone"));
		String server = ResourceUtils.getProperty("mendmix-cloud.lock.redis.servers", ResourceUtils.getProperty("mendmix-cloud.cache.servers"));
		String datebase = ResourceUtils.getProperty("mendmix-cloud.lock.redis.datebase", ResourceUtils.getProperty("mendmix-cloud.cache.datebase","0"));
		String password = ResourceUtils.getProperty("mendmix-cloud.lock.redis.password", ResourceUtils.getProperty("mendmix-cloud.cache.password"));
		String maxPoolSize = ResourceUtils.getProperty("mendmix-cloud.lock.redis.maxPoolSize", ResourceUtils.getProperty("mendmix-cloud.cache.maxPoolSize","100"));
		...
		if("standalone".equals(mode)){
			...
			String masterName = ResourceUtils.getProperty("mendmix-cloud.lock.redis.masterName", ResourceUtils.getProperty("mendmix-cloud.cache.masterName"));
