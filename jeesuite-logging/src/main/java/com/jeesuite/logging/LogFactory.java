...
public final class LogFactory {
  ...
  public static synchronized void useSlf4jLogging() {
    setImplementation(com.jeesuite.logging.adapter.slf4j.Slf4jImpl.class);
  }

  public static synchronized void useLog4JLogging() {
    setImplementation(com.jeesuite.logging.adapter.log4j.Log4jImpl.class);
  }

  public static synchronized void useLog4J2Logging() {
    setImplementation(com.jeesuite.logging.adapter.log4j2.Log4j2Impl.class);
  }

  public static synchronized void useJdkLogging() {
    setImplementation(com.jeesuite.logging.adapter.jdk14.Jdk14LoggingImpl.class);
  }

  public static synchronized void useStdOutLogging() {
    setImplementation(com.jeesuite.logging.adapter.stdout.StdOutImpl.class);
  }
