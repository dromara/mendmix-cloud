 ...
 */
package org.dromara.mendmix.mybatis.core;
...
import org.dromara.mendmix.mybatis.crud.provider.CountByExampleProvider;
import org.dromara.mendmix.mybatis.crud.provider.DeleteByExampleProvider;
import org.dromara.mendmix.mybatis.crud.provider.SelectByExampleProvider;
import org.dromara.mendmix.mybatis.crud.provider.SelectOneByExampleProvider;
import org.dromara.mendmix.mybatis.crud.provider.UpdateWithVersionProvider;
...
public abstract interface BaseMapper<T extends BaseEntity, ID extends Serializable> {
	...
	*/
	...
	int batchLogicDelete(List<ID> ids);
