 ...
 * 
 * <br>
 * Class Name : DeleteByExampleProvider
 *
 * @author jiangwei
 * @version 1.0.0
 * @date 2020年5月11日
 */
public class DeleteByExampleProvider extends AbstractExampleProvider{

	public String deleteByExample(Object example) throws Exception {
		EntityMetadata entityMapper = currentEntityMetadata(example);
		Set<ColumnMetadata> columns = entityMapper.getColumnsMapper();
		SQL sql = new SQL().DELETE_FROM(entityMapper.getTableMapper().getName());
		Object value;
