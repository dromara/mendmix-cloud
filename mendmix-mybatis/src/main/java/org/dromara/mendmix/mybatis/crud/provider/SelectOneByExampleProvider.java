 ...
 * 
 * <br>
 * Class Name   : SelectOneByExampleProvider
 *
 * @author jiangwei
 * @version 1.0.0
 * @date 2020年5月11日
 */
public class SelectOneByExampleProvider extends AbstractExampleProvider{

	public String selectOneByExample(Object example) throws Exception {
